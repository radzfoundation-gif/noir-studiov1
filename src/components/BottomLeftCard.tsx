  ...
  return (
    ...
    >
      <div className="flex flex-col">
        ...
        <span className="text-[10px] md:text-[12px] font-normal text-[rgba(30,50,90,0.6)] uppercase tracking-wider">Photos Generated</span>
      </div>
      <Link href="/gallery">
        <motion.div
        ...
        >
          ...
          <span className="text-[14px] font-normal text-[rgba(30,50,90,0.9)]">View Gallery</span>
        </motion.div>
      </Link>
    </motion.div>
  );
